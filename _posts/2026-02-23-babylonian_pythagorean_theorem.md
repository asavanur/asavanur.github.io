...
There is also evidence that they knew what similar triangles were{%sidenote 'Two' 'J. Hoyrup, Lengths, Widths, Surfaces: A Portrait of Old Babylonian Algebra and its Kin. New York: Springer (2002), p.99' %}. Similar triangles have different sizes but their sides are in the same proportions. A triangle whose sides are 3-4-5 is similar to one whose sides are 6-8-10. (These are actually right triangles and their sides satisfy the theorem.)
