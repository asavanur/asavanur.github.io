...
[Last time](https://asavanur.github.io/articles/26/dividing_up_fields) we set up the problem of dividing a trapezoid in half, the simplest example of a "field division problem". Now we can finish solving it.<!--more--> 
